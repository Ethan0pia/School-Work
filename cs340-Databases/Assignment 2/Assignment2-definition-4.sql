...
CREATE TABLE client (id int AUTO_INCREMENT PRIMARY KEY, first_name VARCHAR(255) NOT NULL,
last_name VARCHAR(255) NOT NULL, dob DATE, CONSTRAINT name_unique UNIQUE (first_name, last_name));
...
last_name VARCHAR(255) NOT NULL, dob DATE, date_joined DATE, CONSTRAINT name_unique UNIQUE (first_name, last_name));
...
CREATE TABLE project (id int AUTO_INCREMENT PRIMARY KEY, cid int, 
name VARCHAR(255) NOT NULL, notes TEXT, FOREIGN KEY(cid) REFERENCES client(id), 
...
CREATE TABLE works_on(eid INT, pid INT,start_date DATE, FOREIGN KEY(eid) REFERENCES employee(id),
FOREIGN KEY(pid) REFERENCES project(id), PRIMARY KEY (eid, pid));
...
VALUES ((SELECT id from client WHERE first_name='Sara' && last_name='Smith'),
...
INSERT INTO project (cid, name, notes)
VALUES ((SELECT id from client WHERE first_name='David' && last_name='Atkins'),
'Eclipse', NULL);
...
INSERT INTO project (cid, name, notes)
VALUES ((SELECT id from client WHERE first_name='Daniel' && last_name='Jensen'),
'Moon', NULL);
